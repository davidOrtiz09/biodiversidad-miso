"""
Django settings for biodiversidad_miso project.
...
ROOT_URLCONF = 'biodiversidad_miso.urls'
...
WSGI_APPLICATION = 'biodiversidad_miso.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'biodiversidad_app', 'static', 'biodiversidad_app'),
)
